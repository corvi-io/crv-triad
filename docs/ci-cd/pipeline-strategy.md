...
deploy to Fly.io. Site and studio deploy to Cloudflare Pages. Third-party actions are pinned to full
...
| --- | --- | --- |
| `API__*`, `IDP__*`, `SITE__*`, `STUDIO__*` | App runtime or browser build inputs | `API__DATABASE_URL`, `STUDIO__VITE_AUTH_BASE_URL` |
