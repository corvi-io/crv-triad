...
- [ ] Confirm ENG-46 is `Done`.
- [ ] Confirm PR #27 is merged into `staging`.
...
- [ ] Read required skills:
  ...
  - [ ] `react-useeffect`;
  - [ ] `ux-copy`.
- [ ] Read the merged ENG-46 implementation and
      `docs/studio/service-desk.md`.
- [ ] Record any divergence between merged ENG-46 and the planning contract
      before editing.
...
- Focused service-session tests:
- Service-desk/Agenda/Dashboard regressions:
