...
describe("workspace brand asset", () => {
  it("keeps the single 48px Triad vector on an accepted gold anchor", () => {
    ...
    expect(triadSymbol).not.toContain("#334155")
    expect(triadSymbol.match(/#86652f/g)).toHaveLength(4)
  })
